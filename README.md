...
This repo contains a Python package called `growth_curve_calculator`, 

Its main purpose is for generating growth curves of cell cultures from optical density measurements.
